...
public class Introvert 
{
	...
	int introvertPercent = 0, extrovertPercent = 0;
	...
	{
		if (answer == 1) extrovertPercent += 10;
		else if (answer == 2) introvertPercent += 10;
	}
	...
	public String result(int answer)
	{
		...
		return "Based off questions 1 to 10 you are " + introvertPercent + "% introvert and " + extrovertPercent + "% extrovert.";
	}
